...
Sleeping places:
2;</h4><p>
The Superior Rooms, 35 m2 in size, provide a high level of comfort, you will enjoy the luxury that surrounds you. In addition to the aesthetic interior design, the rooms provide convenience and space, and the high-speed Internet connection and work desk will satisfy the needs of the business traveler. Features of the room: 1 bedroom (35 m2) 2 twin beds 1 bathroom Minibar Centralized air conditioning, safe Set for tea and coffee Shower, toilet Make-up mirror and hairdryer LCD TV, IP TV, satellite TV, music broadcasting Internet connection and telephone</p>
            <button  type="button" class="btn btn-outline-warning" ><a style="
                text-decoration: none;" href="booking.php"> Booking</a></button>
    </div>
            <div class="col-sm-6">
            <img src="Images/Twin%20room.jpg">
            </div>
    </div>
         </div>
    </div>
