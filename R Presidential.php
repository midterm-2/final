  ...
  <div class=" navbar-collapse" >
   ...
   height="45" alt="Пример"></a></p>';
    ...
    <div class="container">
        ...
        <div class="col-sm-6">
    <h3>ABOUT ROOM</h3>
        <p> <h4>Cost: 2550000тг; Rooms:
3;
Sleeping places:
one;</h4><p>
In the 405 m2 Luxury Suites, offering luxury and comfort of the highest level, you will experience real pleasure. Panoramic views of the city, thoughtful comfort, special interior design and spacious rooms of the suite promise a serene relaxation. Characteristics of the room: Total area (405) 1 bedroom 1 living room 1 bathroom Working area Minibar Centralized air conditioning, safe Set for tea and coffee Bathroom Shower, toilet, bath Make-up mirror and hairdryer Equipment LCD TV, IP TV, satellite TV, music Broadcasting Internet connection and telephone</p>
            <button  type="button" class="btn btn-outline-warning" ><a style="
                text-decoration: none;" href="booking.php"> Booking</a></button>
    </div>
        <div class="col-sm-6">
            <img src="Images/Presidential%20Suite%20Main%20BedroomT.webp">
            </div>
    </div>
         </div></div>
...
Sleeping places:
2;
With 172 m2 of luxurious suites offering luxury and comfort of the highest level, you will experience real pleasure. Panoramic views of the city, thoughtful comfort, special interior design and spacious rooms of the suite promise a serene relaxation. Characteristics of the room: Total area (172 m2) 1 bedroom 1 living room 1 bathroom Working area Minibar Centralized air conditioning, safe Set for tea and coffee Bathroom Shower, toilet, bath Make-up mirror and hairdryer Equipment LCD TV, IP TV, satellite TV, music broadcasting Internet connection and telephone</p>
    </div>
    </div>
        </div>
